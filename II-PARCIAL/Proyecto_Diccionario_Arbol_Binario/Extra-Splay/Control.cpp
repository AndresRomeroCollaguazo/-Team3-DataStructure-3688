...
void llenarArbol(Arbol* arbolIn, Arbol* arbolEs) {
    ...
    if (file.is_open())
    {
        while (getline(file, line))
        {
            ...
            aux.Insertar(id, words.substr(0, words.find("	")), &(arbolIn->raiz));
            aux.PasarARaiz(id, &(arbolIn->raiz));
            aux.Insertar(id, words.substr(words.find("	") + 1, words.length()), &(arbolEs->raiz));
            aux.PasarARaiz(id, &(arbolEs->raiz));
        }
        file.close();
        archivo.close();
    }
    ...
    do {
        ...
        case 1:
            ...
            do {
                ...
                string resp;
                //Inglés a español.
                traduccion = aux.Traducir(arbolIn->raiz, arbolEs->raiz, palabra);
                ...
                suma = suma + " " + traduccion;
                 ...
                 cout << "\nDesea ingresar otra palabra (Pulse cualquier tecla o n para salir) ?" << endl;
        ...
        case 2:
            ...
            do {
               ...
               string palabra1(str);
                ...
                for (int i = 0; i < palabra.length(); i++) {
                    palabra1[i] = tolower(*(palabra.c_str() + i));
                }
         


                //Español a inglés.
                traduccion = aux.Traducir(arbolEs->raiz, arbolIn->raiz, palabra1);
