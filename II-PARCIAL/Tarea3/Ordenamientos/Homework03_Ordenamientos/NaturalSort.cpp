...
void NaturalSort::mezcla(FILE *fich)
{
   ...
   do {
      aux[0] = fopen("C:\\Users\\Jorge\\Desktop\\C C++\\Ordenamientos Lamda\\aux1.txt", "w+");
      aux[1] = fopen("C:\\Users\\Jorge\\Desktop\\C C++\\Ordenamientos Lamda\\aux2.txt", "w+");
      rewind(fich);
      separar(fich, aux);
      rewind(*(aux+0));
      rewind(*(aux+1));
   ...
   remove("C:\\Users\\Jorge\\Desktop\\C C++\\Ordenamientos Lamda\\aux1.txt");
   remove("C:\\Users\\Jorge\\Desktop\\C C++\\Ordenamientos Lamda\\aux2.txt");
}
